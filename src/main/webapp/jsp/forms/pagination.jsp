...
<div class="pagination">
    <c:if test="${requestScope.total_pages > 1}">
        <a href="controller?command=${requestScope.command}&page=1"><fmt:message key="msg.page.first"/></a>
        ...
        <a href="controller?command=${requestScope.command}&page=${requestScope.total_pages}"><fmt:message
                key="msg.page.last"/></a>
    </c:if>
</div>